                                ...
                                <div className="col-lg-12">
                                    <div className="single-page pr-30 mb-lg-0 mb-sm-5">
                                        <div className="single-header style-2">
                                            ...
                                            <p>This Privacy Policy describes how your personal information is collected, used, and shared when you visit or make a purchase from kingoodie.com (the “Site”).</p>
                                        </div>
                                        <div className="single-content mb-50">
                                            ...
                                            <h4>CONTACT US</h4>
                                            <p>For more information about our privacy practices, if you have questions, or if you would like to make a complaint, please contact us by e‑mail at <strong>kingoodie2023@gmail.com</strong></p>
                                            <ol>
