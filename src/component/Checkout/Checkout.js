...
function Checkout() {
  ...
  var Sub_Total_price = GetCart.map(
  ...
  const SubmitHandler = async (e) => {
    ...
    try {
      ...
      const Data = {
        ...
        user_id,
        payment_method: login_type,
        total_amount: Math.round(Sub_Total_price),
        address_same_type: 1,
  ...
  function placeOrder(payment_id = null) {
    ...
    const Data = {
      ...
      total_amount: Math.round(main_Sub_Total_price),
      address_same_type: 1,
      payment_status: PaymentStatus,
      payment_type: PaymentTypes,
      payment_id,
  ...
  function GetaddressList() {
    const addressData =
      `${urlConstant.User.UserAddresses}/` + parseInt(user_id);
    common
      .httpGet(addressData)
      .then(function (res) {
    ...
    axios
      ...
      .then(function (res) {
        ...
        if (delhiveryArray[0] == "Y" || delhiveryArray[1] == "Y") {
          setPinMessage(
            "This product is available for courier delivery at " +
              PinCode +
              " location."
          );
            ...
            <div className="col-lg-10 mb-40">
              ...
              <div className="d-flex justify-content-between">
                <h6 className="text-body">
                  There are <span className="text-brand">{GetCart.length}</span>{" "}
            ...
            <div className="col-lg-7">
              <div className="row mb-50">
                <div className="col-lg-6 apply-coupon">
                  ...
                  />
                  <button
                    className="btn btn-md button-size"
                    onClick={() => {
                  ...
                  <form method="post">
                    ...
                    <div className="form-group mb-30">
                      <textarea
                        ...
                        onChange={(e) => {
                          SetAdditionalInfomation(e.target.value);
                        }}
                      />
                    </div>
            ...
            <div className="col-lg-5">
                            ...
                            <tr key={i}>
                              ...
                              <td>
                                <h6 className="w-160 mb-5">
                                  <a className="text-heading">{product_name}</a>
                                </h6>
                              ...
                              <td>
                                <h4 className="text-brand">
                                  {currency_symbol + price * quantity}
                                </h4>
                              </td>
                            </tr>
                          </>
                      ...
                      <tr>
                        ...
                        <td className="cart_total_amount">
                          <h5 className="text-heading text-end">
                            - {CouponResult == null ? "₹0" : "₹" + CouponResult}
                          </h5>
                        </td>
                      </tr>
                      {onlineDescount == 0 ||
                      ...
                      <tr>
                        ...
                        <td className="cart_total_amount">
                          {onlineDescount == 0 || payment_method == "cod" ? (
                            <h4 className="text-brand text-end">
                              ₹{Math.round(Sub_Total_price) - CouponResult}
                            </h4>
                          ) : (
                            <h4 className="text-heading text-end">
                              ₹{Math.round(onlineSubTotalPrice) - CouponResult}
                            </h4>
                          )}
                        </td>
                      </tr>
              ...
              <div className="payment ml-30">
                ...
                <label style={{ color: "red" }}>
                  Please use <b>Razorpay</b> Payment gateway if you are from
                  india.
                </label>
                <div className="payment_option">
                  ...
                  {Showcodbtn == 0 ? (
                    <div
                      ...
                      style={{
                        display:
                          show == true || showStripe == true ? "none" : "",
                      }}
                    >
                      <input
                        className="form-check-input"
                  ...
                  <div className="custome-radio">
                    ...
                    >
                      ...
                      <span style={{ color: "green" }}>
                        (Instant 5% less on online payment.)
                      </span>
                    </label>
                  </div>
                </div>
                ...
                <a
                  className="btn btn-fill-out btn-block mt-30"
                  style={{
                    display: show == true || showStripe == true ? "none" : "",
                  }}
